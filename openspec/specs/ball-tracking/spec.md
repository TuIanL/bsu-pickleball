...
## Purpose
Define backend ball detection and trajectory artifact behavior for the first pickleball-specific perception phase, including source-labeled continuity and explicit unavailable states.
