...
## Purpose
Define the first-phase multi-target pickleball perception contract for player, ball, and paddle detections while keeping model-specific detector assets optional.
