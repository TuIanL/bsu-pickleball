...
## Purpose
Define Field Session timeline events as manually or system-generated timestamped context attached to a court-side capture task, optionally aligned to a specific RecordingSession.
