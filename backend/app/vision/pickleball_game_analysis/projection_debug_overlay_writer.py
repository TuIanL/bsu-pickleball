...
class ProjectionDebugOverlayWriter:
    ...
    def write_frame(
        ...
        for pos in positions:
            ...
            footpoint = pos.image_footpoint if hasattr(pos, "image_footpoint") and pos.image_footpoint and len(pos.image_footpoint) >= 2 else None
            method = getattr(pos, "footpoint_method", None) or "unknown"
            status = getattr(pos, "projection_status", None) or "unknown"
            court = pos.court_position if hasattr(pos, "court_position") and pos.court_position and len(pos.court_position) >= 2 else None
            ...
            if bbox is not None:
                ...
                cv2.putText(annotated, label, (x1, max(16, y1 - 6)),
                           cv2.FONT_HERSHEY_SIMPLEX, 0.42, box_color, 2, cv2.LINE_AA)
            ...
            if footpoint is not None:
                ...
                cv2.drawMarker(annotated, (fx, fy), cross_color,
            ...
            cv2.putText(annotated, status_text, (12, max(20, y_offset)),
