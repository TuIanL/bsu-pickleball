...
class AnalysisUploadMetadata(BaseModel):
    ...
    sourceFps: float | None = Field(default=None, gt=0, le=240)
    matchTitle: str  # 比赛标题
    venue: str  # 场馆
    matchDate: str  # 比赛日期
    ...
    camera_slot: Literal["cam_1", "cam_2"] | None = None  # 双摄机位标识
...
class AnalysisPipelineOptions(BaseModel):
    ...
    sourceFps: float | None = Field(default=None, gt=0, le=240)
    courtViewMatchThreshold: float | None = Field(default=None, ge=0.0, le=1.0)  # 覆盖场地视角门控匹配阈值
...
class AnalysisStage(BaseModel):
    ...
    durationMs: int | None = None  # 耗时（毫秒）
    progress: int = Field(default=0, ge=0, le=100)  # 进度百分比
    errorCode: str | None = None
    publicMessage: str | None = None  # 给用户看的信息
    internalMessage: str | None = None  # 内部调试信息
...
class AnalysisJobCreate(BaseModel):
    ...
    courtViewMatchThreshold: float | None = Field(default=None, ge=0.0, le=1.0)
    clipStartMs: int | None = Field(default=None, ge=0)
    clipEndMs: int | None = Field(default=None, ge=0)
    captureSegmentId: str | None = None
    segmentVersion: int | None = None
    recording_session_id: str | None = None
    camera_slot: Literal["cam_1", "cam_2"] | None = None
...
class AnalysisJobSummary(BaseModel):
    ...
    displayStatus: AnalysisJobStatus | None = None
    ...
    configSignature: str | None = None  # 配置签名
    analysisVersion: int = Field(default=1, ge=1)
    previousJobId: str | None = None
    frameStride: int = Field(default=1, ge=1)
    sourceFps: float | None = Field(default=None, gt=0, le=240)
    metadata: AnalysisUploadMetadata
    ...
    errorCode: str | None = None
    publicErrorMessage: str | None = None
    internalErrorMessage: str | None = None
    videoId: str | None = None
    calibrationId: str | None = None
    ...
    captureSegmentId: str | None = None
    segmentVersion: int | None = None
    recordingSessionId: str | None = None
    cameraSlot: Literal["cam_1", "cam_2"] | None = None
