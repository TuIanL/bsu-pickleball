...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_capture_coding_actions_annotation_package_id", "capture_coding_actions", ["annotation_package_id"]
    )
    op.create_index(
        "ix_capture_coding_actions_vidat_import_audit_id", "capture_coding_actions", ["vidat_import_audit_id"]
    )
    ...
    op.create_index(
        "ix_session_timeline_events_annotation_package_id", "session_timeline_events", ["annotation_package_id"]
    )
    op.create_index(
        "ix_session_timeline_events_vidat_import_audit_id", "session_timeline_events", ["vidat_import_audit_id"]
    )
