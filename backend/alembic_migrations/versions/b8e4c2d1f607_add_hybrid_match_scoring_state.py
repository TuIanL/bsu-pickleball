...
def upgrade() -> None:
    ...
    op.add_column(
        "live_coding_states", sa.Column("scoring_phase", sa.String(16), nullable=False, server_default="rally")
    )
    op.add_column("live_coding_states", sa.Column("serving_side", sa.String(8), nullable=True))
    op.add_column(
        "live_coding_states", sa.Column("match_status", sa.String(16), nullable=False, server_default="not_started")
    )
